...
This template generates a `.cursor/rules/vortex.mdc` file in the workspace.

## Output File

- **Filename:** `vortex.mdc`
- **Location:** `.cursor/rules/` (relative to workspace root)
...
---
    ...
    ---
    description: Vortex personal context rules — {{DOMAIN_DESCRIPTION}}
    alwaysApply: true
    ---
